/*
	...
	This java file is responsible for displaying student-details
	from the database. It also gives an option to remove a student.
...
public class StudentDetails extends JFrame implements ActionListener{
	...
	// This method selects students from the database and sets to the table
	public void student() {
		try {
	...
	public StudentDetails() {
		super("Student Details - Library Management System");
		...
		Image i5 = i4.getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 88, 133), 2, true), "Student Details", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 88, 133)));
		panel.setBackground(Color.WHITE);
		panel.setBounds(28, 54, 793, 368);
		contentPane.add(panel);

		student(); //Invoking student method
	}
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			if(e.getSource() == b2) {
				String sql = "delete from student where name = '" + searchField.getText() + "'";
				PreparedStatement statement = establishConnection.connection.prepareStatement(sql);
